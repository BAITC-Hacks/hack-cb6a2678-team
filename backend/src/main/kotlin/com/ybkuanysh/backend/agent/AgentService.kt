...
class AgentService(
    ...
    companion object {
        private val SYSTEM_PROMPT = """
            ...
            Для вопросов о погоде (ветер, температура, обледенение, шторм) используй getWeather — это реальные
            архивные прогнозы ECMWF. Запрашивай ровно те дни, о которых спросили (date и toDate).
            Отвечай по полю conclusions, не противоречь ему и не делай своих выводов о рисках.
            Ветер указывай в м/с, температуру в °C, время — в UTC.
