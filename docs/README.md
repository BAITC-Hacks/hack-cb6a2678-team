...
| [../ML/README.md](../ML/README.md), [../ML/TRAINING.md](../ML/TRAINING.md) | ML | ML-сервис: запуск, обучение, метрики, решения |
| [archive/](archive/README.md) | все | Завершённые планы и задания (история решений) |
